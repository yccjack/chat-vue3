...
//获取版本更新的内容chatAi_0.1.8_x64_zh-CN
//签名、版本路径、发版日期
const signature =  fs.readFileSync(`./src-tauri/target/release/bundle/msi/chatAi_${newVersion}_x64_zh-CN.msi.sig`, 'utf8');
updateJson.signature = signature;
updateJson.url = `https://gschaos.club/update_file/chatAi_${newVersion}_x64_zh-CN.msi`
