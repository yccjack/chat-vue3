<template>
  <div id="__next">
    ...
    <div class="overflow-hidden w-full h-full relative">
      ...
      :apiUrl="apiUrl"
      @update_parent_new_chat="handleUpdate"
      @update_parent_cid="handleUpdate"
      @update_parent_openSidebar="handleUpdate"
      ></mNav>
...
function saveConversations() {
  var conversations_put = JSON.parse(JSON.stringify(conversations.value));
